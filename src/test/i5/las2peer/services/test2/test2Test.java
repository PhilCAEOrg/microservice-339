 ...
 * 339 - Test Class
 *
 * This class provides a basic testing framework for the microservice 339. It was
...
public class test2Test {
  ...
  private static final String mainPath = "test2";
  ...
  public void testtest2() {
    ...
    try {
      ...
      ClientResponse result = c.sendRequest("GET", mainPath + "/test2", test2.toJSONString(),
